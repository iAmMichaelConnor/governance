...
| Constant                          | Value                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| --------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Contract address domain separator | **Must be bumped before the v6 release candidate.** Every protocol version uses a fresh separator so the same contract address cannot exist on two rollup instances (v4: `DOM_SEP__CONTRACT_ADDRESS_V1 = 1788365517`; v5: `DOM_SEP__CONTRACT_ADDRESS_V2 = 4099338721`). As of 2026-09-21 the `next` branch of aztec-packages still carries `V2 = 4099338721`, identical to v5, so v6 would allow address collisions with v5. The bump to `DOM_SEP__CONTRACT_ADDRESS_V3 = hash_to_u32("az_dom_sep", "contract_address_v3")` is in progress in aztec-packages; *TBD: record the value here once merged.* |
...
1. The contract address domain separator has not yet been bumped on `next` (see above). This is time-sensitive given the testnet payload date.
